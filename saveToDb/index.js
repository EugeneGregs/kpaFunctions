...
module.exports = function (context, req) {
    ...
    function sendActionToUserWithoutError(){
        ...
        const options = {
            uri: /*'http://localhost:7071/api/sendActioncard',*/ 'https://kpaincidentsfunc.azurewebsites.net/api/sendActioncard?code=CGqJPc8VjhAsVXrAiivzg2BSPUEHU7ecI2mSwCoIWaymZ8REl8Xy1w==',
            method: 'POST',
            json: data
        };
